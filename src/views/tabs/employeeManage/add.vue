                ...
                <el-form :rules="rules" ref="employee" :model="employee" label-width="100px">
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="入职时间" prop="hireDate">
                                <el-date-picker type="date" placeholder="入职时间"
                                                v-model="employee.hireDate"></el-date-picker>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                    ...
                    <el-row>
                        <el-form-item label="管理影院组" required prop="cinemaGroupIds">
                            ...
                            <cinema-checkbox v-model="employee.cinemaGroupIds"></cinema-checkbox>
                        </el-form-item>
                    </el-row>
                    <el-row>
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="submitForm('employee')"
                                   v-loading.fullscreen.lock="fullscreenLoading">立即创建
                        </el-button>
